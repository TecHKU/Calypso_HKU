  ...
  render() {
    ...
    return (
      <div className={"container-fluid"}>
            ...
            <div className={"container"} style={styles.homepageContent}>
              ...
              <div className={"row"} style={styles.homepageBannerText}>
                <h2 style={{ marginTop: "1rem" }}>
                  Discover, present and collaborate on student projects all over
                  HKU
                </h2>
              </div>
              <div
                className={"row d-flex justify-content-center"}
                style={styles.homepageBannerRows}
              >
                <a href={"#projects"}>
                  <button
        ...
        <div className={"row"} style={{ backgroundColor: "#FEFEFE" }}>
          <div className={"container"}>
            <div className={"row"} style={styles.homepageContentRows}>
              <div
                style={styles.flexColumn}
                className={"col-lg-8 col-sm-12 ml-auto mr-auto"}
              >
                <div>
                  <h2>
                    Looking for teammates in HKU to startup your great idea?
                  </h2>
                  <p>
                    Post your great ideas for everyone to review. Get connected
                    with students who are interested in your project and get a
                    chance to collaborate with them.
                  </p>
                </div>

                <HomepageButtons
                  text="Advertise your project"
                  link="/newproject"
                />
              </div>
              <div className={"col-lg-4 col-sm-12 ml-auto mr-auto"}>
                <img
                  src={require("../imgs/homeilloteam.png")}
          ...
          <div className={"container"}>
            <div className={"row"} style={styles.homepageContentRows}>
              <div className={"col-lg-4 col-sm-12"}>
                <img
                  src={require("../imgs/homeprojects.png")}
                  style={{ width: "100%", padding: "10px" }}
                />
              </div>
              ...
              <div className={"col-lg-8 col-sm-12"}>
                ...
                <p>
                  Find projects that interest you the most and contact the
                  coordinator from right here. Still exploring? Go ahead and
                  search from the whole catalog of projects.
                </p>
